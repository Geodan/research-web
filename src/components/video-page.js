            ...
            <div class="graybackground">
                <div class="content">
                    ...
                    <div class="videodemo">
                        ...
                        <iframe  src="https://www.youtube.com/embed/${this.demos[0].url}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    _loadConfig() {
        fetch(this.config).then(response=>{
            ...
            this.demos = demos.filter(demo=>!demo.disabled && demo.url === videoUrl).map(demo=>{
                ...
                demo.url = demo.url.substring(17);
                return demo;
            });
        })
    }
